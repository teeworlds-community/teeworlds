...
void CMenus::RenderServerbrowserBottomBox(CUIRect MainView)
{
	...
	if(DoButton_Menu(&s_RefreshButton, Localize("Refresh"), 0, &Button) || UI()->KeyPress(KEY_F5) || ((UI()->KeyPress(KEY_R) && (Input()->KeyIsPressed(KEY_LCTRL) || Input()->KeyIsPressed(KEY_RCTRL)))))
	{
